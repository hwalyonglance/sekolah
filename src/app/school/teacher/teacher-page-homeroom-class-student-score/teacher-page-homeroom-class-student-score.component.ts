...
@Component({
	selector: 'teacher-page-homeroom-class-student-score',
	template: `
		<teacher-dashboard>
			<div class='center'>
				<mat-toolbar color='primary'>
					Keterangan Nilai Guru
				</mat-toolbar>
...
export class TeacherPageHomeroomClassStudentScoreComponent implements AfterViewInit, OnInit {
		...
		this._activatedRoute.params
			.subscribe(
				params => {
					...
					this._api.getByQuery('scores_v', {class_id, student_id})
						.subscribe(
							(teacherAssignmentV: TeacherAssignmentV) => {
